...
package com.aixohub.algotrader.broker.ib.controller;
...
public class ApiConnection extends EClientSocket {
    ...
    public ApiConnection(EWrapper wrapper, Logger inLogger, Logger outLogger) {
    ...
    protected void sendMsg(EMessage msg) throws IOException {
        ...
        if (m_outLogger != null) {
            m_outLogger.info(new String(buf, StandardCharsets.UTF_8));
        }
    }
    ...
    public int readInt() throws IOException {
        ...
        if (m_inLogger != null) {
            m_inLogger.info(String.valueOf((char) c));
        }
    ...
    public int read(byte[] buf, int off, int len) throws IOException {
        ...
        if (m_inLogger != null) {
            m_inLogger.info(new String(buf, 0, n, StandardCharsets.UTF_8));
        }
