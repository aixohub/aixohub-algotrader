...
public class ApiController implements EWrapper {
    ...
    private final Logger m_inLogger;
    ...
    public void updateMktDepth(int reqId, int position, int operation, int side, double price,
        ...
        if (handler != null) {
            handler.updateMktDepth(position, null, Types.DeepType.get(operation), Types.DeepSide.get(side), price,
                    size);
        }
        recEOM();
    }
    ...
    public void updateMktDepthL2(int reqId, int position, String marketMaker, int operation, int side,
        ...
        IDeepMktDataHandler handler = m_deepMktDataMap.get(reqId);
        if (handler != null) {
            handler.updateMktDepth(position, marketMaker, Types.DeepType.get(operation), Types.DeepSide.get(side),
                    price, size);
        }
        recEOM();
    }
    ...
    public void updateGroups(List<Group> groups) {
        ...
        m_client.replaceFA(REPLACE_FA_GROUPS_REQ_ID, Types.FADataType.GROUPS.ordinal(),
    ...
    public void updateProfiles(List<Profile> profiles) {
        ...
        m_client.replaceFA(REPLACE_FA_PROFILES_REQ_ID, Types.FADataType.PROFILES.ordinal(),
    ...
    public void exerciseOption(String account, Contract contract, Types.ExerciseType type, int quantity,
                               boolean override) {
        if (!checkConnection()) {
            return;
        }
    ...
    public void historicalData(int reqId, Bar bar) {
        ...
        if (handler != null) {
            if (bar.time().startsWith("finished")) {
                ...
                com.ib.controller.Bar bar2 = new com.ib.controller.Bar(bar.time(), bar.high(), bar.low(), bar.open(), bar.close(), bar.wap(),
    ...
    public void reqRealTimeBars(Contract contract, Types.WhatToShow whatToShow, boolean rthOnly,
    ...
    public void reqFundamentals(Contract contract, Types.FundamentalType reportType,
    ...
    public void reqHeadTimestamp(Contract contract, Types.WhatToShow whatToShow, boolean rthOnly,
    ...
    public void reqHistogramData(Contract contract, int duration, Types.DurationUnit durationUnit,
    ...
    public void reqHistoricalSchedule(Contract contract, String endDateTime, int duration,
                                      Types.DurationUnit durationUnit, boolean rthOnly, IHistoricalScheduleHandler handler) {
        if (!checkConnection()) {
            return;
        }
        ...
        String durationStr = duration + " " + durationUnit.toString().charAt(0);
        m_client.reqHistoricalData(reqId, contract, endDateTime, durationStr, Types.BarSize._1_day.toString(),
                Types.WhatToShow.SCHEDULE.name(), rthOnly ? 1 : 0, 2, false, Collections.emptyList());
    ...
    public interface IConnectionHandler {
        ...
        void connected(IConnectionConfiguration conn);
    ...
    public interface IDeepMktDataHandler {
        ...
        void updateMktDepth(int position, String marketMaker, Types.DeepType operation, Types.DeepSide side,
