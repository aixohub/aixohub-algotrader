...
public abstract class EClient {
  ...
  public synchronized void placeOrder(int id, Contract contract, Order order) {
    ...
    if (m_serverVersion < MIN_SERVER_VER_ORDER_COMBO_LEGS_PRICE && Types.SecType.BAG.name()
    ...
    try {
      ...
      if (m_serverVersion >= MIN_SERVER_VER_SMART_COMBO_ROUTING_PARAMS && Types.SecType.BAG.name()
          .equalsIgnoreCase(contract.getSecType())) {
