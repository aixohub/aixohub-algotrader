...
public class ContractDetails {
  ...
  public ContractDetails(Contract p_contract, String p_marketName,
      ...
      String p_realExpirationDate, String p_lastTradeTime,
      String p_stockType, Decimal p_minSize, Decimal p_sizeIncrement,
      Decimal p_suggestedSizeIncrement) {
  ...
  public Decimal suggestedSizeIncrement() {
    return m_suggestedSizeIncrement;
  }
  ...
  public void minSize(Decimal minSize) {
    m_minSize = minSize;
  }

  public void sizeIncrement(Decimal sizeIncrement) {
    m_sizeIncrement = sizeIncrement;
  }

  public void suggestedSizeIncrement(Decimal suggestedSizeIncrement) {
    m_suggestedSizeIncrement = suggestedSizeIncrement;
  }
