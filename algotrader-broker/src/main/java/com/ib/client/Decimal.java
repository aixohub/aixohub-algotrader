...
public class Decimal implements Comparable<Decimal> {
  ...
  public static final Decimal INVALID = new Decimal(BigDecimal.valueOf(
      Long.MIN_VALUE)); // maybe would better to choose 0 as invalid's value, as in at least half of the operations invalid behaves 0 like
  ...
  public static final Decimal NaN = new Decimal(BigDecimal.valueOf(
      Long.MIN_VALUE)) { // we need NaN for bar replacement at the moment, if it can be solved differently remove it
    @Override
