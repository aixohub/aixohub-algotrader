...
public class Order {
  ...
  public String toString() {
    return "Order{" +
            ...
            ", m_tif='" + m_tif + '\'' +
            ", m_account='" + m_account + '\'' +
            ", m_settlingFirm='" + m_settlingFirm + '\'' +
            ", m_clearingAccount='" + m_clearingAccount + '\'' +
            ", m_clearingIntent='" + m_clearingIntent + '\'' +
            ...
            ", m_activeStartTime='" + m_activeStartTime + '\'' +
            ", m_activeStopTime='" + m_activeStopTime + '\'' +
            ", m_faGroup='" + m_faGroup + '\'' +
            ...
            ", m_deltaNeutralOpenClose='" + m_deltaNeutralOpenClose + '\'' +
            ", m_deltaNeutralShortSale=" + m_deltaNeutralShortSale +
            ", m_deltaNeutralShortSaleSlot=" + m_deltaNeutralShortSaleSlot +
            ", m_deltaNeutralDesignatedLocation='" + m_deltaNeutralDesignatedLocation + '\'' +
            ...
            ", m_origin=" + m_origin +
            ", m_shortSaleSlot=" + m_shortSaleSlot +
            ", m_designatedLocation='" + m_designatedLocation + '\'' +
            ", m_exemptCode=" + m_exemptCode +
            ", m_deltaNeutralSettlingFirm='" + m_deltaNeutralSettlingFirm + '\'' +
            ", m_deltaNeutralClearingAccount='" + m_deltaNeutralClearingAccount + '\'' +
            ", m_deltaNeutralClearingIntent='" + m_deltaNeutralClearingIntent + '\'' +
            ", m_discretionaryAmt=" + m_discretionaryAmt +
            ", m_optOutSmartRouting=" + m_optOutSmartRouting +
            ", m_auctionStrategy=" + m_auctionStrategy +
            ...
            ", m_basisPoints=" + m_basisPoints +
            ", m_basisPointsType=" + m_basisPointsType +
            ", m_notHeld=" + m_notHeld +
            ", m_orderMiscOptions=" + m_orderMiscOptions +
            ", m_solicited=" + m_solicited +
            ", m_randomizeSize=" + m_randomizeSize +
            ", m_randomizePrice=" + m_randomizePrice +
            ", m_referenceContractId=" + m_referenceContractId +
            ", m_peggedChangeAmount=" + m_peggedChangeAmount +
            ", m_isPeggedChangeAmountDecrease=" + m_isPeggedChangeAmountDecrease +
            ", m_referenceChangeAmount=" + m_referenceChangeAmount +
            ", m_referenceExchangeId='" + m_referenceExchangeId + '\'' +
            ", m_adjustedOrderType=" + m_adjustedOrderType +
            ", m_triggerPrice=" + m_triggerPrice +
            ", m_adjustedStopPrice=" + m_adjustedStopPrice +
            ", m_adjustedStopLimitPrice=" + m_adjustedStopLimitPrice +
            ", m_adjustedTrailingAmount=" + m_adjustedTrailingAmount +
            ", m_adjustableTrailingUnit=" + m_adjustableTrailingUnit +
            ", m_lmtPriceOffset=" + m_lmtPriceOffset +
            ", m_conditions=" + m_conditions +
            ", m_conditionsCancelOrder=" + m_conditionsCancelOrder +
            ", m_conditionsIgnoreRth=" + m_conditionsIgnoreRth +
            ", m_modelCode='" + m_modelCode + '\'' +
            ", m_extOperator='" + m_extOperator + '\'' +
            ", m_softDollarTier=" + m_softDollarTier +
            ", m_cashQty=" + m_cashQty +
            ", m_mifid2DecisionMaker='" + m_mifid2DecisionMaker + '\'' +
            ", m_mifid2DecisionAlgo='" + m_mifid2DecisionAlgo + '\'' +
            ", m_mifid2ExecutionTrader='" + m_mifid2ExecutionTrader + '\'' +
            ", m_mifid2ExecutionAlgo='" + m_mifid2ExecutionAlgo + '\'' +
            ", m_dontUseAutoPriceForHedge=" + m_dontUseAutoPriceForHedge +
            ", m_isOmsContainer=" + m_isOmsContainer +
            ", m_discretionaryUpToLimitPrice=" + m_discretionaryUpToLimitPrice +
            ", m_autoCancelDate='" + m_autoCancelDate + '\'' +
            ", m_filledQuantity=" + m_filledQuantity +
            ", m_refFuturesConId=" + m_refFuturesConId +
            ", m_autoCancelParent=" + m_autoCancelParent +
            ", m_shareholder='" + m_shareholder + '\'' +
            ", m_imbalanceOnly=" + m_imbalanceOnly +
            ", m_routeMarketableToBbo=" + m_routeMarketableToBbo +
            ", m_parentPermId=" + m_parentPermId +
            ", m_usePriceMgmtAlgo=" + m_usePriceMgmtAlgo +
            ", m_duration=" + m_duration +
            ", m_postToAts=" + m_postToAts +
            ", m_advancedErrorOverride='" + m_advancedErrorOverride + '\'' +
            ", m_manualOrderTime='" + m_manualOrderTime + '\'' +
            ", m_minTradeQty=" + m_minTradeQty +
            ", m_minCompeteSize=" + m_minCompeteSize +
            ", m_competeAgainstBestOffset=" + m_competeAgainstBestOffset +
            ", m_midOffsetAtWhole=" + m_midOffsetAtWhole +
            ", m_midOffsetAtHalf=" + m_midOffsetAtHalf +
            '}';
  }
}
