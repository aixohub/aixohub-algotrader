package com.aixohub.algotrader.service.quant.util;
        ...
        for (HttpMessageConverter<?> converter : converters) {
            if (converter instanceof MappingJackson2HttpMessageConverter) {
                ...
                jsonConverter.setSupportedMediaTypes(
                        ImmutableList.of(new MediaType("application", MediaType.APPLICATION_JSON_UTF8_VALUE),
                                new MediaType("text", MediaType.APPLICATION_FORM_URLENCODED_VALUE)));
            }
        }
